...
if (resultado < 18.5) {
    alert (nombre + " tu IMC= " + redondo + " y es demasiado bajo, consulte a su nutricionista");
    } else if (resultado >= 18.5 && resultado < 25){
        alert (nombre + " tu IMC= " + redondo + " y es normal, manten una dieta saludable.");
    } else if (resultado >= 25 && resultado < 30){
        alert (nombre + " tu IMC= " + redondo + " y tienes Sobrepeso , consulte a su nutricionista.");    
    }  else if (resultado >= 30){
        alert (nombre + " tu IMC= " + redondo + " y  estas obeso, debes consultar al nutricionista.");
    }  
